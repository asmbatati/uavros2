...
|----------|-------------------|---------|
| Indoor Navigation | `warehouse.sdf` | Structured environment with known dimensions |
| Warehouse Robotics | `warehouse.sdf` | Realistic warehouse layout with obstacles |
| Outdoor Navigation | `urban2.sdf` or `urban1.sdf` | Natural terrain with elevation changes |
| Multi-environment Testing | All three | Comprehensive evaluation across environments |
| Algorithm Development | `warehouse.sdf` | Controlled, predictable environment |

### Performance Considerations
- **Warehouse**: Lowest computational overhead, fastest simulation
- **Taif/DEM Worlds**: Higher computational overhead due to complex terrain mesh
- **Recommended**: Start development with warehouse, then test on terrain worlds
